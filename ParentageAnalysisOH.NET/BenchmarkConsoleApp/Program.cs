...
{
    private static ZygosityDataset? ComparisonDataset;
    ...
    public OppositeHomozygoteBenchmarks()
    {
        ...
        //ComparisonDataset = new ZygosityDataset(@"Datasets\1000+3000 samples 15000 markers.raw", parentsGen1, generation2Ids).LoadDataset();
    ...
    // BenchmarkDotNet does not work with static methods.
#pragma warning disable CA1822 // Mark members as static
    ...
    public void ComparisonUngroupedShortCircuitByte()
    {
        ...
        ComputeCountsSingleThread(zygs, zygs, (byte)((double)ComparisonDataset.VariantCount! * 0.0035), Convert.ToByte);
    }
    //[Benchmark]
    public void ComparisonUngroupedCompleteUInt16()
    {
        var zygs = ComparisonDataset!.OffspringIds!.Concat(ComparisonDataset!.ParentIds!).Select(id => ComparisonDataset!.Zygosities![id]).ToArray();
        ComputeCountsSingleThread(zygs, zygs, UInt16.MaxValue, Convert.ToUInt16);
    }
